...
import { MessageCircle, Users, Zap, Globe, Star, Shield, Spline } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Engage in natural, intelligent conversations with AI personalities tailored to your needs."
    },
    {
      icon: Users,
      title: "Multiple Personalities",
      description: "Choose from a diverse range of AI personas - from experts to entertainers."
    },
    {
      icon: Zap,
      title: "Instant Responses",
      description: "Get lightning-fast replies with advanced AI processing and real-time interactions."
    },
    {
      icon: Globe,
      title: "Global Access",
      description: "Connect with AI companions from anywhere in the world, 24/7 availability."
    },
    {
      icon: Star,
      title: "Premium Quality",
      description: "Experience cutting-edge AI technology with continuous learning and improvements."
    },
    {
      icon: Shield,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-purple-200 max-w-2xl mx-auto">
              Discover the power of AI conversation with our cutting-edge features designed to enhance your experience.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-r from-[#170552]/90 to-[#48237c]/80 backdrop-blur-sm rounded-3xl p-12 border border-purple-300/20">
              ...
              <p className="text-xl text-purple-200 mb-8 max-w-2xl mx-auto">
                Join thousands of users already experiencing the future of conversation with AI technology.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-purple-200 mb-6 max-w-md">
                Revolutionizing communication through advanced AI technology. Connect, learn, and explore with intelligent companions that understand you.
              </p>
              <div className="flex space-x-4">
                <div className="w-10 h-10 bg-purple-500/20 rounded-full flex items-center justify-center hover:bg-purple-500/40 transition-colors cursor-pointer">
